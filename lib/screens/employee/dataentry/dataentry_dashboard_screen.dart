...
class DataEntryDashboardScreen extends StatefulWidget {
  const DataEntryDashboardScreen({super.key});

  @override
  State<DataEntryDashboardScreen> createState() => _SalesDashboardScreenState();
}

class _SalesDashboardScreenState extends State<DataEntryDashboardScreen> {
            ...
            Row(
              ...
              children: [
                Column(
                  ...
                  children: [
                    Text(
                      'Welcome Back, Data Entry Person!',
                      style: TextStyle(
                        fontSize: 22,
                        fontWeight: FontWeight.bold,
